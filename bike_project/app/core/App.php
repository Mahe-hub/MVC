...
Class App{
 ...
 public function __construct(){
     ...
     // now we will check  the method in the controller
        // but before that we need to check if the element in the url array which save the 
        // method is not null
    //    if(isset($url[1])){
    //         // this will check the method and take 2 arg the first one is for class ,second one the name of method
